...
tx = Transaction(WebpayOptions(IntegrationType.TEST, "597055555532", "579B532A7440BB0C9079DED94D31EA1615BACEB56610332264630D42D0A36B1C"))
...
class ProductoViewSet(viewsets.ModelViewSet):
    ...
    def crear_en_sucursales(self, request):
        ...
        try:
            ...
            if not all([nombre, categoria, precio_base]):
                return Response({
                    'error': 'Faltan campos requeridos: nombre, categoria, precio_base'
